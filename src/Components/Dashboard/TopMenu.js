...
function contentDb(left, width) {
  ...
  for (
    let i = 0;
    i < document.getElementsByClassName("content-dashboard").length;
    i++
  ) {
    document.getElementsByClassName("content-dashboard")[i].style.flex =
      "0 0 " + width;
    document.getElementsByClassName("content-dashboard")[i].style.maxWidth =
      width;
  }
  Boolean = !Boolean;
}
